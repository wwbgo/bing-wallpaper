...
[Run]
Filename: "{app}\bing-wallpaper.exe"; Parameters: "setup --time 09:30 --resolution auto --style fill"; Description: "立即更新并配置每日必应壁纸"; Flags: runhidden waituntilterminated skipifsilent
